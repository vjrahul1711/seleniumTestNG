...
public class LoginLogoutDataProvider1Test extends BaseTestClass {
    ...
    public void testLoginValidCred(String username, String password) throws IOException, URISyntaxException {
        ...
        if (g) {
            ...
            System.out.println(actualUname + "User is logged in");
        }
        else {
